...
void test_sql_print_condition_name_list(char **condition_name_list, int count) {

    int i = 0;

    printf("--------------------------------\n");
    printf("| condition_name_list \n");
    printf("--------------------------------\n");
    for (i = 0; i <= count - 1; ++i) {

        printf("| %s\n", condition_name_list[i]);
        printf("--------------------------------\n");
    }
}

void test_sql_print_condition_operator_list(char **condition_operator_list, int count) {

    int i = 0;

    printf("--------------------------------\n");
    printf("| condition_operator_list \n");
    printf("--------------------------------\n");
    for (i = 0; i <= count - 1; ++i) {
...
void test_sql_print_condition_value_list(char **condition_value_lis, int count) {

    int i = 0;

    printf("--------------------------------\n");
    printf("| condition_value_lis \n");
    printf("--------------------------------\n");
    for (i = 0; i <= count - 1; ++i) {

        printf("| %s\n", condition_value_lis[i]);
        printf("--------------------------------\n");
    }
}
